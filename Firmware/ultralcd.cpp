...
void lcd_wizard(int state) {
	...
	while (!end) {
		...
		case 0: // run wizard?
    #ifdef COREXY
      wizard_event = lcd_show_multiscreen_message_yes_no_and_wait_P(_i("Hi, I am your Original Prusa CoreXY printer. Would you like me to guide you through the setup process?"), false, true);////MSG_WIZARD_WELCOME c=20 r=7
    #else
